...
public class MessageKeys {
    ...
    public static final String LOGIN_PASSWORD_INCORRECT = "user.login.wrong_phone_password";
    ...
    public static final String PASSWORD_NOT_MATCH = "user.register.password_not_matched";
    public static final String PHONE_EXISTS = "user.register.phone_existed";
    public static final String ROLE_NOT_FOUND = "user.login.role_not_exist";
    public static final String REGISTER_NOT_ADMIN = "user.register.admin";
